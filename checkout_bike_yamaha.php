...
<body>
  ...
  <div class="container">
    <div class="image">     
         <img src="https://www.drivespark.com/bikes-photos/modelsoverview/450x400/735/yamaha-yzf-r15-v3-review-verdict.jpg/3/x.pagespeed.ic.p_8qQYoRoZ.jpg" id="img"> 
    </div>
    <div class="heading">
        <h3></h3>
        <h3 id="car_heading">YAMAHA YZF R15 V3</h3>
        ...
        <form action="orders.php" method="post">
            ...
            <div class="details">
              ...
              <input type="text" name="rent" value="250" style="display:none;" >
            </form> 
        </div>
    </div>
