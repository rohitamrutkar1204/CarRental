...
<head>
  ...
  <title>>ROYAL ENFIELD BULLET 350</title>
</head>
<body>
  ...
  <div class="container">
    <div class="image">     
         <img src="https://www.drivespark.com/bikes-photos/modelsoverview/450x400/80/royal-enfield-bullet-350-review-design-and-style.jpg/3/x.pagespeed.ic.eEb8mGfW4o.jpg" id="img"> 
    </div>
    <div class="heading">
        <h3 id="car_heading">ROYAL ENFIELD BULLET </h3>
        ...
        <form action="orders.php" method="post">
            ...
            <div class="details">
              ...
              <input type="text" name="rent" value="150" style="display:none;" >
            </form> 
        </div>
    </div>
