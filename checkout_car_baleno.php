...
<body>
  ...
  <div class="container">
    <div class="image">     
         <img src="https://www.globalsuzuki.com/automobile/lineup/baleno/viewer/large/materials/EXT-GRD_GLX-BG_A-BC_ZZH/EXT-GRD_GLX-BG_A-BC_ZZH_02.jpg" id="img"> 
    </div>
    <div class="heading">
       
        <h3 id="car_heading">BALENO</h3>
        ...
        <form action="orders.php" method="post">
            ...
            <div class="details">
              ...
              <input type="text" name="rent" value="2000" style="display:none;" >
            </form> 
        </div>
    </div>
