...
<body>
  ...
  <div class="container">
    <div class="image">     
         <img src="https://www.hgpmart.com/media/catalog/product/cache/1/image/400x400/55cff407ede0de17959b0c1beb04f478/s/p/splendor-plus-bs6-black-sports-red_4.jpg" id="img"> 
    </div>
    <div class="heading">
   
        <h3 id="car_heading">Hero Splender Plus </h3>
        ...
        <form action="orders.php" method="post">
            ...
            <div class="details">
              ...
              <input type="text" name="rent" value="200" style="display:none;" >
            </form> 
        </div>
    </div>
