...
<body>
  ...
  <div class="container">
    <div class="image">     
         <img src="https://imgd.aeplcdn.com/1056x594/cw/ec/26860/Maruti-Suzuki-Dzire-Front-view-105300.jpg?v=201711021421&q=85" id="img"> 
    </div>
    <div class="heading">
        <h3 id="car_heading">Maruti Suzuki  </h3>
        ...
        <form action="orders.php" method="post">
            ...
            <span> <p>Start Date:</p></span>
              <input type="text" id="startdate"  name="startdate" placeholder="Month / Day / Year" required>
            <span> <p id="to">To</p></span>
              <span><p>End Date:</p></span>
              <input type="text" id="enddate"    name="enddate" placeholder="Month / Day / Year" required>
            </div>
            <div class="vl"></div>
            <div class="details">
              ...
              <input type="text" name="rent" value="1500" style="display:none;" >
            </form> 
