...
<body>
  ...
  <div class="container">
    <div class="image">     
         <img src="https://imgd.aeplcdn.com/0x0/n/cw/ec/21497/kuv100-nxt-exterior-front-view.jpeg" id="img"> 
    </div>
    <div class="heading">
        
        <h3 id="car_heading">MAHINDRA KUV 100 </h3>
        ...
        <form action="orders.php" method="post">
            ...
            <div class="details">
              ...
              <input type="text" name="rent" value="2500" style="display:none;" >
            </form> 
