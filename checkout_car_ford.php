...
<body>
  ...
  <div class="container">
    <div class="image">     
         <img src="https://imgd.aeplcdn.com/1056x594/n/cw/ec/35463/figo-exterior-front-view.jpeg?q=85" id="img"> 
    </div>
    <div class="heading">
        <h3 id="car_heading">FORD FIGO </h3>
        <h3 id="heading_booking">Booking Details</h3>
        <!-- <h3 id="heading_booking1">Details</h3> -->
        ...
        <form action="orders.php" method="post">
            ...
            <div class="details">
              ...
              <input type="text" name="rent" value="1000" style="display:none;" >
            </form> 
        </div>
    </div>
